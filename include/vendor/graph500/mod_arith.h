...
#include "vendor/graph500/user_settings.h"
...
#ifdef __MTA__
#include "vendor/graph500/mod_arith_xmt.h"
#else
#ifdef FAST_64BIT_ARITHMETIC
#include "vendor/graph500/mod_arith_64bit.h"
#else
#include "vendor/graph500/mod_arith_32bit.h"
#endif
#endif
